...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is jasmine.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a recent graduate of ucla (go bruins!),")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("where i studied cog sci + computing.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm also interested in design and teaching.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("fan of anything made with potatoes.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
